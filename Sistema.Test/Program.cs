...
namespace Sistema.Test
{
    internal class Program
    {
        ...
        public static void CrearEvento()
        {
            ...
            Crud<Evento>.EndPoint = "https://localhost:7096/api/Eventos";
        ...
        public static void CrearSeccion()
        {
            ...
            Crud<Seccion>.EndPoint = "https://localhost:7096/api/Secciones";
        ...
        public static void CrearPonente()
        {
            ...
            Crud<Ponente>.EndPoint = "https://localhost:7096/api/Ponentes";
        ...
        public static void CrearParticipante()
        {
            ...
            Crud<Participante>.EndPoint = "https://localhost:7096/api/Participantes";
        ...
        public static void CrearInscripcion()
        {
            ...
            Crud<Inscripcion>.EndPoint = "https://localhost:7096/api/Inscripciones";
        ...
        public static void CrearPago()
        {
            ...
            Crud<Pago>.EndPoint = "https://localhost:7096/api/Pagos";
        ...
        {
            Console.WriteLine("Ingrese el nombre de la sala");
            string nombre = Console.ReadLine();
            Console.WriteLine("Ingrese ubicacion");
            string ubicacion = Console.ReadLine();


            Crud<Sala>.EndPoint = "https://localhost:7096/api/Salas";
            ...
            Console.WriteLine($"Sala creada con exito: {sala.Codigo}");
        }
        ...
        public static void CrearCertificado()
        {
            ...
            Crud<Certificado>.EndPoint = "https://localhost:7096/api/Certificados";
